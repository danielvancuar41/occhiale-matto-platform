...
export const BRAND_RULES = {
  ...
  vincoli_inviolabili: [
    ...
    "LOGO SU SFONDO SCURO: il logo Occhiale Matto è bianco su PNG trasparente (URL https://d3k81ch9hvuctc.cloudfront.net/company/SuvjeA/images/efab9e30-782b-4853-8d7b-d6184c7e3458.png). Quindi DEVE sempre stare su un blocco con background:#1a1a1a (nero) sia nell'header che nel footer, in tutti i template TRANNE il template STATEMENT. Anche se il template è MINIMAL o EDITORIAL con tema CHIARO, il rettangolo dietro al logo va comunque scuro, altrimenti il logo bianco diventa invisibile su crema/bianco. Sbagliato: <td style=\"background:#faf7f2\"><img src=\"logo bianco\"></td>. Giusto: <td style=\"background:#1a1a1a;padding:28px 20px\" align=\"center\"><img src=\"logo bianco\" width=\"180\"></td>. ECCEZIONE — TEMPLATE STATEMENT: qui NON si usa il logo bianco e NON si usa sfondo scuro. Si usa il logo NERO (URL https://d3k81ch9hvuctc.cloudfront.net/company/SuvjeA/images/264a5c95-09ae-4713-835f-a3f31dac4a15.png) su sfondo bianco, sia header che footer. Segui le istruzioni del template STATEMENT, non questa regola, quando il template selezionato è statement."
  ],
