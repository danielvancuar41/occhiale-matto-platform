...
export const BRAND_RULES = {
  ...
  vincoli_inviolabili: [
    ...
    "DIMENSIONI IMMAGINI tutte uguali, MAI TAGLIARE LA FOTO: ogni immagine prodotto deve avere ESATTAMENTE gli stessi attributi width=\"280\" height=\"280\" e stile style=\"display:block;width:100%;max-width:280px;height:280px;object-fit:contain;background-color:#ffffff\". CRITICO: usa object-fit:CONTAIN (non cover). Cover taglia la foto e mostra parti mancanti dell'occhiale (telai tagliati, lenti incomplete). Contain mostra l'occhiale INTERO con eventuale spazio bianco sui lati o sopra/sotto se l'aspect ratio della foto è diverso. Le foto degli occhiali OM hanno aspect ratio diversi (alcune quadrate, alcune wide), quindi CONTAIN è l'unica scelta per non tagliarle. L'altezza fissa 280px serve solo a uniformare l'ingombro visivo nella griglia.",
    ...
    "LOGO SU SFONDO SCURO: il logo Occhiale Matto è bianco su PNG trasparente (URL https://d3k81ch9hvuctc.cloudfront.net/company/SuvjeA/images/efab9e30-782b-4853-8d7b-d6184c7e3458.png). Quindi DEVE sempre stare su un blocco con background:#1a1a1a (nero) sia nell'header che nel footer, IN OGNI TEMPLATE. Anche se il template è MINIMAL o EDITORIAL con tema CHIARO, il rettangolo dietro al logo va comunque scuro, altrimenti il logo bianco diventa invisibile su crema/bianco. Sbagliato: <td style=\"background:#faf7f2\"><img src=\"logo bianco\"></td>. Giusto: <td style=\"background:#1a1a1a;padding:28px 20px\" align=\"center\"><img src=\"logo bianco\" width=\"180\"></td>."
  ],
